...
;              Since the API is returning a new answer upon each request, api-cache should remain at 1
; DEFAULT:     3600
...
oauth_secret = ""
; FORMAT:      string
; DESCRIPTION: Place the clientid and secret generated by tools/setup.php
